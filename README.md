...
Este proyecto consiste en el desarrollo de una API REST realizada en C# utilizando ASP.NET Core y .NET 8. El objetivo es crear una API sencilla que permita administrar información sobre mascotas, en este caso perros y gatos.
